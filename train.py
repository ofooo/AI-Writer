...
datafile = "E:/code/learn/fish_writer/data/novels/斗破苍穹.txt"
...
print('model', model_type, 'epoch', n_epoch, 'batchsz', batch_size, 'betas', betas, 'eps', eps, 'wd', weight_decay, 'ctx', ctx_len, 'layer', n_layer,
      'head', n_head, 'embd', n_embd, 'attn', n_attn, 'ffn', n_ffn)
tconf = TrainerConfig(model_type=model_type, max_epochs=n_epoch, batch_size=batch_size, weight_decay=weight_decay,
                      ...
                      warmup_tokens=0, final_tokens=n_epoch * len(train_dataset) * ctx_len, num_workers=0, epoch_save_frequency=epoch_save_frequency,
